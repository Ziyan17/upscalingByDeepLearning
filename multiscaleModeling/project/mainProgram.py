...
import time
'''
N = 20 # number of observation points in the main fracture
dt = 1000
tMax = 50000
porosity = 0.1
'''
...
def mainFractureFirstRun():
    os.chdir("./00mainFracture")
...
def mainFractureRecord():
    os.chdir("./00mainFracture/postProcessing/netWallSamplingLeakyA")
    concentrationDataA, pressureDataA = mainFractureRecordHelper()
    os.chdir("../../../")
    os.chdir("./00mainFracture/postProcessing/netWallSamplingLeakyB")
    concentrationDataB, pressureDataB = mainFractureRecordHelper()
    os.chdir("../../../")
    os.chdir("./00mainFracture/postProcessing/netWallSamplingLeakyC")
    concentrationDataC, pressureDataC = mainFractureRecordHelper()
    os.chdir("../../../")
    os.chdir("./00mainFracture/postProcessing/netWallSamplingLeakyD")
